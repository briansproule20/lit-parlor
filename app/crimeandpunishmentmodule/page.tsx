    ...
    <main className="min-h-screen py-8 px-4 relative" style={{
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid lg:grid-cols-3 md:grid-cols-2 gap-8">
          ...
          {/* Character Analysis */}
          <div className="bg-purple-50/95 border-4 border-purple-600 rounded-xl p-6 shadow-2xl transform rotate-1 transition-all duration-300 hover:scale-105 hover:rotate-2 hover:shadow-3xl cursor-pointer">
          ...
          {/* Symbolic Analysis */}
          <div className="bg-purple-50/95 border-4 border-purple-600 rounded-xl p-6 shadow-2xl transform rotate-2 transition-all duration-300 hover:scale-105 hover:rotate-3 hover:shadow-3xl cursor-pointer">
            <div className="text-center mb-6">
