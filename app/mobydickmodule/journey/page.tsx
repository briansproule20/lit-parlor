            ...
            >
              <div className="bg-gradient-to-br from-amber-800 to-amber-700 p-4 rounded-lg border-2 border-amber-500 shadow-inner">
                <img
                  ...
                  className={selectedChapter.id === 5 || selectedChapter.id === 6 || selectedChapter.id === 7 || selectedChapter.id === 8 ? "w-full h-[90vh] object-cover rounded border border-amber-400" : "w-full h-[28rem] object-cover rounded border border-amber-400"}
                />
              </div>
            </div>
          )}
