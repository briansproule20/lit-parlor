    ...
    <main className="min-h-screen py-8 px-4 relative" style={{
      ...
      {isModalOpen && selectedChapter && (
        <div className={`fixed inset-0 z-50 flex items-center ${showVisualJourney ? 'justify-start' : 'justify-center'} p-4`}>
          ...
          {showVisualJourney && (
            <div 
              className={`fixed top-1/2 transform -translate-y-1/2 z-60 transition-opacity duration-1000 ${selectedChapter.id === 3 ? 'left-1/2 translate-x-1/4' : selectedChapter.id === 5 ? 'left-1/2 translate-x-1/4' : selectedChapter.id === 6 ? 'left-1/2 translate-x-1/4' : 'right-8'}`}
            ...
            >
              <div className="bg-gradient-to-br from-amber-800 to-amber-700 p-4 rounded-lg border-2 border-amber-500 shadow-inner">
                <img
                  ...
                  className={selectedChapter.id === 5 || selectedChapter.id === 6 ? "w-full h-[90vh] object-cover rounded border border-amber-400" : "w-full h-[28rem] object-cover rounded border border-amber-400"}
                />
              </div>
            </div>
          )}
