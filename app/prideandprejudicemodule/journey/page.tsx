...
export default function PrideAndPrejudiceJourney() {
  return (
        ...
        <div className="text-center">
          <div className="inline-block p-8 bg-gradient-to-r from-rose-900/90 to-pink-800/90 border-4 border-rose-400 rounded-2xl shadow-2xl">
            ...
            <p className="text-rose-200 text-lg mb-6 font-serif">
              The interactive journey through Pride and Prejudice is currently in development.
            </p>
            <p className="text-rose-200 text-lg mb-6 font-serif">
              Soon you'll be able to explore Elizabeth and Darcy's story through detailed character analysis, 
              thematic exploration, and interactive elements.
            </p>
