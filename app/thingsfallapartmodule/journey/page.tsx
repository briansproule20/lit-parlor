...
export default function ThingsFallApartJourney() {
  return (
        ...
        <div className="text-center">
          <div className="inline-block p-8 bg-gradient-to-r from-orange-900/90 to-red-800/90 border-4 border-orange-400 rounded-2xl shadow-2xl">
            ...
            <p className="text-orange-200 text-lg mb-6 font-serif">
              The interactive journey through Things Fall Apart is currently in development.
            </p>
            <p className="text-orange-200 text-lg mb-6 font-serif">
              Soon you'll be able to explore Okonkwo's story through detailed character analysis, 
